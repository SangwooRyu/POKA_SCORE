...
public class Soccer {
	...
	public SashForm SoccerTab(Composite sports_tab) {
          ...
          button1.addSelectionListener(new SelectionAdapter()  {	  
        		...
        		public void widgetSelected(SelectionEvent e) {
        			...
        			if(source.getSelection()){
        				File first = new File(Main.filePath + "/soccer/score_전반.png");
        				File second = new File(Main.filePath + "/soccer/score_후반.png");
        				File third = new File(Main.filePath + "/soccer/score_연장.png");			
        				File curr = new File(Main.filePath + "/soccer/score_current.png");
        				File temp = new File(Main.filePath + "/soccer/score_temp.png");
        				...
        				else if (first.exists() && second.exists() && third.exists()) {
        					curr.delete();
        					try {
    							Main.copyFileUsingChannel(first, temp);
    						} catch (IOException e1) {
